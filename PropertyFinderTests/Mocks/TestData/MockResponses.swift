...
/// Collection of mock JSON responses for testing
enum MockResponses {
    /// Valid JSON response for property list endpoint
    ...
    /// Valid JSON response for property detail endpoint
    ...
    /// Invalid JSON response for testing error handling
